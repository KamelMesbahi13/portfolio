...
//         {isOpen && (
//           <div className="absolute inset-0 pointer-events-none bg-gradient-to-br from-mainColor/10 via-mainColor/5 to-transparent" />
//         )}
...
//           <p className="max-w-3xl mx-auto mt-4 text-base md:text-lg text-textColorWhite dark:text-textColorDark">
