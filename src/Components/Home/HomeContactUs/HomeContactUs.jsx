...
//           }
//           className={`w-full px-2 sm:px-3 md:px-4 py-2 sm:py-2.5 md:py-3 text-xs sm:text-sm text-gray-900 transition-all border outline-none rounded-lg sm:rounded-xl bg-gray-50/50 hover:bg-gray-50
//             ${
//               errors[name] && touched[name]
//                 ? "border-red-400 focus:border-red-500 focus:ring-2 focus:ring-red-500/20 pr-8"
//                 : "border-gray-200 focus:border-secondColor focus:ring-2 focus:ring-secondColor/20"
//             }
//           `}
//         />
//         {errors[name] && touched[name] && (
...
//             exit={{ opacity: 0, y: -5 }}
//             className="text-[10px] sm:text-xs text-red-500 flex items-center gap-1"
//           >
//             {errors[name]}
//           </motion.p>
//         )}
...
//                     maxLength={1000}
//                     className={`w-full px-2 sm:px-3 md:px-4 py-2 sm:py-2.5 md:py-3 text-xs sm:text-sm text-gray-900 transition-all border outline-none resize-none rounded-lg sm:rounded-xl bg-gray-50/50 hover:bg-gray-50 sm:rows-3 md:rows-4
//                       ${
...
//                     )}
//                   </AnimatePresence>
//                   <p className="text-[10px] sm:text-xs text-gray-400 ml-auto">
